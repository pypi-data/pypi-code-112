...
distributions = Extension("extending_distributions",
                          ...
                          libraries=['npyrandom', 'npymath',
                                     # IRC is needed because in Intel(R) Distribution for Python*
                                     # libnpyrandom.a has unresolved symbols from Intel(R) C Compiler
                                     # rune-time libraries. Linking against irc resolves them.
                                     # The alternative is to build the extension with ICC
                                     # CC=icc LDSHARED='icc -shared -shared-intel' python setup.py
                                     'irc'],
                          define_macros=defs,
                          )
